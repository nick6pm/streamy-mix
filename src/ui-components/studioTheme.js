...
export default createTheme({
  ...
  tokens: {
    components: {
      ...
      expander: {
        ...
        item: {
          ...
          _focus: { boxShadow: { value: "[object Object]" } },
        },
        header: { boxShadow: { value: "[object Object]" } },
        trigger: {
      ...
      switchfield: {
        ...
        large: { font: { size: { value: "{fontSizes.large.value}" } } },
        small: { font: { size: { value: "{fontSizes.small.value}" } } },
        thumb: {
          backgroundColor: { value: "{colors.background.primary.value}" },
          borderColor: { value: "{colors.border.tertiary.value}" },
    ...
    shadows: {
      small: { value: "[object Object]" },
      medium: { value: "[object Object]" },
      large: { value: "[object Object]" },
    },
    space: {
      xxxs: { value: "0.25rem" },
      xxs: { value: "0.375rem" },
